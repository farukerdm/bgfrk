      ...
      <div class="card">
        ...
        <div class="card-grid">
          ...
          <div class="card">
            ...
            <a href="#" class="btn btn-primary" onclick="alert('Manuel sunucu ekleme özelliği geliştirme aşamasındadır!')">
              <span class="btn-icon">➕</span>
              Manuel Sunucu Ekle
            </a>
          </div>
...
def pg_install():
    ...
    try:
        if not PG_INSTALL_AVAILABLE:
            return "<h1>Hata</h1><p>PostgreSQL Installation modülü yüklenemedi</p><a href='/'>Ana Sayfaya Dön</a>"
        ...
        return f"<h1>Hata</h1><p>PostgreSQL Installation sayfası yüklenemedi: {str(e)}</p><a href='/'>Ana Sayfaya Dön</a>"
